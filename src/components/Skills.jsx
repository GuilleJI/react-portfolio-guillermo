...
const skills =[
    ...
    {id: 2, name: "Web Development", description: "Proficient in website design and development using HTML, CSS (SASS, Tailwind CSS, Bootstrap),JavaScript (React.js, Node.js), and C# (ASP.NET).", image: "src/images/webdev.png"},
    {id: 3, name: "Data Management", description: "Familiar with data fundamentals, including SQL, ADO.NET, and Entity Framework.", image: "src/images/datamanagement.png"},
    {id: 4, name: "Mobile Development", description: "Experienced in Java and Kotlin for Android development using Android Studio.", image: "src/images/mobiledev.png"},
    {id: 5, name: "Version Control", description: "Proficient in Git, with experience in managing GitHub projects including branches and commits.", image: "src/images/versioncontrol.png"},
    {id: 6, name: "Design Tools", description: "Proficient in Figma for interface design, prototyping, and real-time collaboration. Furthermore, I am adept at using Figma's vector editing capabilities and components feature to create reusable design elements, ensuring consistency across all designs.", image: "src/images/figma.png"},
    ...
    {id: 9, name: "Problem-solving", description: "Experienced in applying logical reasoning to tackle intricate challenges, a proficiency developed through extensive involvement in programming and systems analysis tasks.", image: "src/images/problemsolving.png"},
