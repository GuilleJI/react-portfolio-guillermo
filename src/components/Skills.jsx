...
const skills =[
    ...
    {id: 6, name: "Design Tools", description: "Proficient in Figma for interface design, prototyping, and real-time collaboration.", image: "src/images/FigmaDesign.png"},
    ...
    {id: 12, name: "Eagerness to Learn", description: "Proactively pursuing new experiences and knowledge to enhance exiting skills.", image: "src/images/Learning.png"},
]
const Skills = () => {
    return (
